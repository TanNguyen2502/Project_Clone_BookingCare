                    ...
                    <div className="container"> 
                        <div className="row">
                            ...
                            <div className="col-12 my-3">
                                <button className={ this.state.action === CRUD_ACTIONS.EDIT ? "btn btn-warning btn-admin" : "btn btn-primary btn-admin" }
                            ...
                            <div className="col-12 mb-5">
                                <TableManageUser    handleEditFromParentKey={this.handleEditUserFromParent}
